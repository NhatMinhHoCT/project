          ...
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="<?=BASE_PATH?>admin/logout" aria-expanded="false">
                ...
                <span class="hide-menu"> <?=$_SESSION["user"]["username"]?> | [Thoát]</span>
              </a>
            </li>
            <?php
              }
            ...
            <li class="sidebar-item">
            <a class="sidebar-link" href="<?=BASE_PATH?>admin/addproductform" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
            <a class="sidebar-link" href="<?=BASE_PATH?>admin/addcatalogform" aria-expanded="false">
                <span>
                <i class="fa-solid fa-pen-to-square"></i>
                </span>
